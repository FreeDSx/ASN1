...
class GeneralizedTimeTypeSpec extends ObjectBehavior
{
    ...
    public function it_should_be_constructed_with_a_datetime_of_the_current_time_if_none_is_given()
    {
        $this->beConstructedWith();
        $this->getValue()->shouldBeAnInstanceOf(\DateTime::class);
    }

    public function it_should_extend_abstract_time()
    {
        $this->shouldBeAnInstanceOf(AbstractTimeType::class);
    }

    public function it_should_default_to_fractions_of_a_second()
    {
        $this->getDateTimeFormat()->shouldBeEqualTo(AbstractTimeType::FORMAT_FRACTIONS);
    }

    public function it_should_default_to_a_UTC_timezone_ending()
    {
    ...
    public function it_should_set_the_time_format()
    {
    ...
    public function it_should_set_the_timezone_format()
    {
    ...
    public function it_should_not_allow_setting_the_time_format_to_something_invalid()
    {
        $this->shouldThrow(InvalidArgumentException::class)->during('setDateTimeFormat', ['foo']);
    }

    public function it_should_not_allow_setting_the_timezone_format_to_something_invalid()
    {

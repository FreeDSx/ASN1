...
class SequenceOfTypeSpec extends ObjectBehavior
{
    function let()
    {
    ...
    {
        $this->shouldHaveType(SequenceOfType::class);
    }
    ...
    {
        $this->getTagNumber()->shouldBeEqualTo(AbstractType::TAG_TYPE_SEQUENCE);
    }
    ...
    function it_should_be_constructed_with_tag_information()
    {
        $this::withTag(1, AbstractType::TAG_CLASS_APPLICATION, [new IntegerType(1)])->shouldBeLike(
            (new SequenceOfType(new IntegerType(1)))->setTagNumber(1)->setTagClass(AbstractType::TAG_CLASS_APPLICATION)
        );
    }
}

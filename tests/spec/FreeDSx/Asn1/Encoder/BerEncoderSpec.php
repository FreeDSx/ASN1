...
class BerEncoderSpec extends ObjectBehavior
{
    ...
    public function it_should_implement_the_encoder_interface()
    {
    ...
    public function it_should_decode_long_definite_length_when_the_length_is_the_exact_size_of_the_payload()
    {
    ...
    public function it_should_decode_long_definite_length()
    {
    ...
    public function it_should_encode_long_definite_length()
    {
    ...
    public function it_should_decode_a_null_type()
    {
        $this->decode(hex2bin('0500'))->shouldBeLike(new NullType());
    }

    public function it_should_encode_a_null_type()
    {
        $this->encode(new NullType())->shouldBeEqualTo(hex2bin('0500'));
    }

    public function it_should_decode_a_zero_integer_type()
    {
        $this->decode(hex2bin('020100'))->shouldBeLike(new IntegerType(0));
    }

    public function it_should_encode_a_zero_integer_type()
    {
        $this->encode(new IntegerType(0))->shouldBeEqualTo(hex2bin('020100'));
    }

    public function it_should_decode_a_big_int_positive_integer_type()
    {
    ...
    public function it_should_decode_a_positive_integer_type()
    {
    ...
    public function it_should_encode_a_big_int_positive_integer_type()
    {
        if (!extension_loaded('gmp')) {
            throw new SkippingException('The GMP extension must be loaded for bigint specs.');
        }
    ...
    public function it_should_encode_a_positive_integer_type()
    {
    ...
    public function it_should_decode_a_big_int_negative_integer_type()
    {
        if (!extension_loaded('gmp')) {
            throw new SkippingException('The GMP extension must be loaded for bigint specs.');
        }
    ...
    public function it_should_decode_a_negative_integer_type()
    {
    ...
    public function it_should_encode_a_big_int_negative_integer_type()
    {
        if (!extension_loaded('gmp')) {
            throw new SkippingException('The GMP extension must be loaded for bigint specs.');
        }
    ...
    public function it_should_encode_a_negative_integer_type()
    {
    ...
    public function it_should_encode_a_real_type_special_cases()
    {
    ...
    public function it_should_decode_a_real_type_special_cases()
    {
    ...
    public function it_should_decode_an_octet_string_type()
    {
    ...
    public function it_should_encode_an_octet_string()
    {
    ...
    public function it_should_decode_an_enumerated_type()
    {
        $this->decode(hex2bin('0A0101'))->shouldBeLike(new EnumeratedType(1));
    }

    public function it_should_encode_an_enumerated_type()
    {
        $this->encode(new EnumeratedType(1))->shouldBeEqualTo(hex2bin('0A0101'));
    }

    public function it_should_decode_a_sequence_type()
    {
    ...
    public function it_should_encode_a_sequence_type()
    {
    ...
    public function it_should_encode_a_bit_string()
    {
    ...
    public function it_should_encode_a_bit_string_to_a_min_length_if_specified()
    {
        $this->encode(BitStringType::fromInteger(1, 32))->shouldBeEqualTo(hex2bin('03050001000000'));
    }

    public function it_should_not_allow_an_invalid_amount_of_unused_bits_in_a_bit_string_when_decoding()
    {
    ...
    public function it_should_decode_a_bit_string()
    {
    ...
    public function it_should_decode_an_oid_with_a_bigint()
    {
        if (!extension_loaded('gmp')) {
            throw new SkippingException('The GMP extension must be loaded for bigint specs.');
        }
    ...
    public function it_should_decode_an_oid_with_a_bigint_in_the_second_component()
    {
        if (!extension_loaded('gmp')) {
            throw new SkippingException('The GMP extension must be loaded for bigint specs.');
        }
    ...
    public function it_should_decode_an_oid()
    {
    ...
    public function it_should_encode_an_oid_with_a_bigint()
    {
        if (!extension_loaded('gmp')) {
            throw new SkippingException('The GMP extension must be loaded for bigint specs.');
        }
    ...
    public function it_should_encode_an_oid_with_a_bigint_in_the_second_component()
    {
        if (!extension_loaded('gmp')) {
            throw new SkippingException('The GMP extension must be loaded for bigint specs.');
        }
    ...
    public function it_should_encode_an_oid()
    {
    ...
    public function it_should_not_accept_an_oid_with_a_first_identifier_greater_than_2()
    {
        $this->shouldThrow(EncoderException::class)->during('encode', [new OidType('3.1')]);
    }

    public function it_should_encode_a_generalized_time_string_non_utc_with_a_differential()
    {
    ...
    public function it_should_encode_a_generalized_time_string_utc_with_an_ending_Z()
    {
    ...
    public function it_should_encode_a_generalized_time_string_as_local_time_if_specified()
    {
    ...
    public function it_should_encode_a_generalized_time_with_fractional_seconds_if_they_exist()
    {
    ...
    public function it_should_not_encode_a_generalized_time_with_fractional_seconds_if_specified()
    {
    ...
    public function it_should_encode_a_generalized_time_string_to_hours()
    {
    ...
    public function it_should_encode_a_generalized_time_string_to_minutes()
    {
        $this->encode(new GeneralizedTimeType(
    ...
    public function it_should_throw_an_exception_if_the_hour_is_equal_to_24_when_decoding()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('180b') . '2018031824Z']);
    }

    public function it_should_decode_a_generalized_time_string_with_hours_in_UTC()
    {
    ...
    public function it_should_decode_a_generalized_time_string_in_local_time_form()
    {
    ...
    public function it_should_decode_a_generalized_time_string_with_minutes()
    {
    ...
    public function it_should_decode_a_generalized_time_string_with_seconds()
    {
    ...
    public function it_should_decode_a_generalized_time_string_with_fractions_of_a_second()
    {
    ...
    public function it_should_decode_a_generalized_time_string_with_a_time_differential()
    {
    ...
    public function it_should_decode_a_UTC_time_with_seconds()
    {
    ...
    public function it_should_decode_a_UTC_time_without_seconds()
    {
    ...
    public function it_should_decode_a_UTC_time_with_a_differential_timezone()
    {
    ...
    public function it_should_not_accept_decoding_UTC_time_with_no_timezone_modifier()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [(hex2bin('170c') . '181106210627')]);
    }

    public function it_should_not_accept_decoding_UTC_time_with_24_hour_midnight()
    {
    ...
    public function it_should_encode_a_UTC_time_with_seconds()
    {
    ...
    public function it_should_encode_a_UTC_time_without_seconds()
    {
        $this->encode(new UtcTimeType(
            new \DateTime('18-03-18 01:22', new \DateTimeZone('UTC')),
            GeneralizedTimeType::FORMAT_MINUTES,
    ...
    public function it_should_encode_a_UTC_time_with_a_differential_timezone()
    {
        $this->encode(new UtcTimeType(
            new \DateTime('18-11-06 21:06:27', new \DateTimeZone('-0500')),
            GeneralizedTimeType::FORMAT_SECONDS,
    ...
    public function it_should_encode_a_relative_oid_with_a_bigint_value()
    {
        if (!extension_loaded('gmp')) {
            throw new SkippingException('The GMP extension must be loaded for bigint specs.');
        }
    ...
    public function it_should_decode_a_relative_oid()
    {
    ...
    public function it_should_decode_a_relative_oid_with_a_bigint_value()
    {
        if (!extension_loaded('gmp')) {
            throw new SkippingException('The GMP extension must be loaded for bigint specs.');
        }
    ...
    public function it_should_decode_an_unknown_type()
    {
    ...
    public function it_should_throw_an_error_when_decoding_incorrect_length()
    {
        $this->shouldThrow(new EncoderException('The expected byte length was 2, but received 1.'))->duringDecode(hex2bin('010201'));
    }

    public function it_should_throw_an_error_if_indefinite_length_encoding_is_used()
    {
    ...
    public function it_should_return_null_for_the_last_ending_position_if_there_is_none_yet()
    {
        $this->getLastPosition()->shouldBeNull();
    }

    public function it_should_not_change_the_last_position_when_completing_a_type()
    {
    ...
    public function it_should_get_the_last_ending_position()
    {
        $this->decode(hex2bin('0101FF00'))->shouldBeLike(new BooleanType(true));
        $this->getLastPosition()->shouldBeEqualTo(3);
    }

    public function it_should_throw_a_partial_PDU_exception_with_only_a_byte_of_data()
    {
        $this->shouldThrow(PartialPduException::class)->duringDecode(hex2bin('30'));
    }

    public function it_should_throw_a_partial_PDU_exception_without_enough_data_to_decode_length()
    {
    ...
    public function it_should_handle_decoding_a_high_big_int_tag_number()
    {
    ...
    public function it_should_handle_encoding_a_high_big_int_tag_number()
    {
        $this->encode((new OctetStringType("\x01"))->setTagNumber('18446744073709551615'))->shouldBeEqualTo(hex2bin('1f81ffffffffffffffff7f0101'));
    }

    public function it_should_throw_a_partial_pdu_exception_on_a_root_type_with_no_high_tag_ending()
    {
        $this->shouldThrow(PartialPduException::class)->during('decode', [hex2bin('5f8080')]);
    }

    public function it_should_throw_an_encoder_exception_on_a_non_root_type_with_no_high_tag_ending()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('30035f8080')]);
    }

    public function it_should_encode_a_high_tag_number_properly()
    {
        $this->encode((new BooleanType(true))->setTagNumber(128))->shouldBeEqualTo(hex2bin('1f810001ff'));
    }

    public function it_should_throw_an_exception_on_zero_length_boolean()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('0100')]);
    }

    public function it_should_throw_an_exception_on_zero_length_integer()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('0200')]);
    }

    public function it_should_throw_an_exception_on_zero_length_enumerated()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('0a00')]);
    }

    public function it_should_throw_an_exception_on_zero_length_oid()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('0600')]);
    }

    public function it_should_throw_an_exception_on_zero_length_relative_oid()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('0d00')]);
    }

    public function it_should_throw_an_exception_on_zero_length_generalized_time()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('1800')]);
    }

    public function it_should_throw_an_exception_on_zero_length_utc_time()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('1700')]);
    }

    public function it_should_throw_an_exception_if_a_bool_with_more_than_one_byte_of_length_is_encountered()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('0102ffff')]);
    }

    public function it_should_throw_an_exception_if_a_null_with_one_or_more_bytes_of_length_is_encountered()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('050101')]);
    }

    public function it_should_throw_an_exception_on_a_constructed_boolean()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('210101')]);
    }

    public function it_should_throw_an_exception_on_a_constructed_integer()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('220101')]);
    }

    public function it_should_throw_an_exception_on_a_constructed_enumerated()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('2a0101')]);
    }

    public function it_should_throw_an_exception_on_a_constructed_oid()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('38022a7f')]);
    }

    public function it_should_throw_an_exception_on_a_constructed_relative_oid()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('2d022a7f')]);
    }

    public function it_should_throw_an_exception_on_a_constructed_real()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('290101')]);
    }

    public function it_should_throw_an_exception_on_a_constructed_null()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('2500')]);
    }

    public function it_should_throw_an_exception_on_a_primitive_sequence()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('10030101ff')]);
    }

    public function it_should_throw_an_exception_on_a_primitive_set()
    {
        $this->shouldThrow(EncoderException::class)->during('decode', [hex2bin('11030101ff')]);
    }

    public function it_should_throw_an_exception_if_the_integer_to_encode_is_a_big_int_and_gmp_is_not_available()
    {
        if (extension_loaded('gmp')) {
    ...
    public function it_should_throw_an_exception_if_the_integer_to_decode_is_a_big_int_and_gmp_is_not_available()
    {
        if (extension_loaded('gmp')) {
            throw new SkippingException('Only valid when GMP is not loaded.');
        }
    ...
    public function it_should_throw_an_exception_if_the_relative_oid_to_encode_has_a_big_int_and_gmp_is_not_available()
    {
        if (extension_loaded('gmp')) {
            throw new SkippingException('Only valid when GMP is not loaded.');
        }
    ...
    public function it_should_throw_an_exception_if_the_relative_oid_to_decode_has_a_big_int_and_gmp_is_not_available()
    {
        if (extension_loaded('gmp')) {
            throw new SkippingException('Only valid when GMP is not loaded.');
        }
    ...
    public function it_should_throw_an_exception_if_the_oid_to_encode_has_a_big_int_and_gmp_is_not_available()
    {
        if (extension_loaded('gmp')) {
            throw new SkippingException('Only valid when GMP is not loaded.');
        }
    ...
    public function it_should_throw_an_exception_if_the_oid_to_decode_has_a_big_int_and_gmp_is_not_available()
    {
        if (extension_loaded('gmp')) {
            throw new SkippingException('Only valid when GMP is not loaded.');
        }
    ...
    public function it_should_throw_an_error_when_encoding_the_tag_number_if_it_is_not_numeric()
    {
        $this->shouldThrow(EncoderException::class)->during('encode', [(new IntegerType(1))->setTagNumber('foo')]);
    }

    public function it_should_throw_an_error_when_encoding_an_integer_tag_if_it_is_not_numeric()
    {
        $this->shouldThrow(EncoderException::class)->during('encode', [(new IntegerType(1))->setTagNumber('foo')]);
    }

    public function it_should_throw_an_error_when_encoding_an_enumerated_type_if_it_is_not_numeric()
    {
        $this->shouldThrow(EncoderException::class)->during('encode', [(new IntegerType(1))->setTagNumber('foo')]);
    }
}

...
final class CharacterStringTypeTest extends TestCase
{
    private CharacterStringType $subject;

    protected function setUp(): void
    {
        $this->subject = new CharacterStringType('foo');
    }
    ...
    {
        self::assertSame(
            AbstractType::TAG_TYPE_CHARACTER_STRING,
    ...
    public function test_it_should_be_constructed_with_tag_information(): void
    {
        self::assertEquals(
            (new CharacterStringType('foo'))
                ...
                ->setValue('foo'),
            CharacterStringType::withTag(1, AbstractType::TAG_CLASS_APPLICATION, false, 'foo'),
        );
    }
}

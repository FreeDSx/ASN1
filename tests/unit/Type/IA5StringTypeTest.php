...
final class IA5StringTypeTest extends TestCase
{
    private IA5StringType $subject;

    protected function setUp(): void
    {
        $this->subject = new IA5StringType('foo');
    }
    ...
    public function test_it_should_be_constructed_with_tag_information(): void
    {
        self::assertEquals(
            (new IA5StringType('foo'))
                ...
                ->setValue('foo'),
            IA5StringType::withTag(1, AbstractType::TAG_CLASS_APPLICATION, false, 'foo'),
        );
    }
}

...
final class GeneralStringTypeTest extends TestCase
{
    private GeneralStringType $subject;

    protected function setUp(): void
    {
        $this->subject = new GeneralStringType('foo');
    }
    ...
    public function test_it_should_be_constructed_with_tag_information(): void
    {
        self::assertEquals(
            (new GeneralStringType('foo'))
                ...
                ->setValue('foo'),
            GeneralStringType::withTag(1, AbstractType::TAG_CLASS_APPLICATION, false, 'foo'),
        );
    }
}

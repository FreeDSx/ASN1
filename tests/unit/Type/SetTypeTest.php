...
{
    private SetType $subject;

    protected function setUp(): void
    {
        $this->subject = new SetType(
            new IntegerType(1),
    ...
    public function test_it_should_be_able_to_determine_if_it_is_in_canonical_order(): void
    {
        self::assertTrue($this->subject->isCanonical());
        ...
        self::assertFalse($this->subject->isCanonical());

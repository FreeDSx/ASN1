...
final class PrintableStringTypeTest extends TestCase
{
    private PrintableStringType $subject;

    protected function setUp(): void
    {
        $this->subject = new PrintableStringType('foo');
    }
    ...
    public function test_it_should_be_constructed_with_tag_information(): void
    {
        self::assertEquals(
            (new PrintableStringType('foo'))
                ...
                ->setValue('foo'),
            PrintableStringType::withTag(1, AbstractType::TAG_CLASS_APPLICATION, false, 'foo'),
        );
    }
}

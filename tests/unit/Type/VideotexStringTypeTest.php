...
final class VideotexStringTypeTest extends TestCase
{
    private VideotexStringType $subject;

    protected function setUp(): void
    {
        $this->subject = new VideotexStringType('foo');
    }
    ...
    public function test_it_should_be_constructed_with_tag_information(): void
    {
        self::assertEquals(
            ...
            VideotexStringType::withTag(1, AbstractType::TAG_CLASS_APPLICATION, false, 'foo'),
        );
    }
}

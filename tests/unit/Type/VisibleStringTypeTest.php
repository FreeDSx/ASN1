...
final class VisibleStringTypeTest extends TestCase
{
    private VisibleStringType $subject;

    protected function setUp(): void
    {
        $this->subject = new VisibleStringType('foo');
    }
    ...
    public function test_it_should_be_constructed_with_tag_information(): void
    {
        self::assertEquals(
            ...
            VisibleStringType::withTag(1, AbstractType::TAG_CLASS_APPLICATION, false, 'foo'),
        );
    }
}

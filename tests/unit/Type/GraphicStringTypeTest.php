...
final class GraphicStringTypeTest extends TestCase
{
    private GraphicStringType $subject;

    protected function setUp(): void
    {
        $this->subject = new GraphicStringType('foo');
    }
    ...
    public function test_it_should_be_constructed_with_tag_information(): void
    {
        self::assertEquals(
            (new GraphicStringType('foo'))
                ...
                ->setValue('foo'),
            GraphicStringType::withTag(1, AbstractType::TAG_CLASS_APPLICATION, false, 'foo'),
        );
    }
}

...
{
    private NumericStringType $subject;

    protected function setUp(): void
    {
        $this->subject = new NumericStringType('foo');
    }
    ...
    {
        self::assertEquals(
            (new NumericStringType('foo'))
                ->setTagNumber(1)
                ->setTagClass(AbstractType::TAG_CLASS_APPLICATION)
                ->setValue('foo'),
            NumericStringType::withTag(1, AbstractType::TAG_CLASS_APPLICATION, false, 'foo'),
        );
    }
}
